      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            ...
            {
              blogs.map((blog, key) => (
                <div key={key} className="group flex flex-col rounded-lg bg-white shadow-sm transition-all hover:scale-[1.02] hover:shadow-md dark:bg-gray-950 dark:shadow-none dark:hover:bg-gray-800">
                <Image
                  src={blog.coverImage}
                  width="300"
                  height="200"
